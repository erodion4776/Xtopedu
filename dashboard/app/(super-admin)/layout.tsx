...
const navItems = [
  ...
  { href: '/trial-codes', label: 'Trial Codes', icon: Gift },
  { href: '/payment-forms', label: 'Payment Forms', icon: CreditCard },
...
export default function SuperAdminLayout({
  ...
  async function checkAuth() {
    try {
      ...
      setAdminName(admin.full_name?.split(' ')[0] ?? 'Admin');
      setChecking(false);
    } catch (err) {
    ...
    <div className="flex h-screen bg-gray-100 font-sans">
      <aside className={cn(
        ...
        <div className="flex items-center justify-between p-4 border-b">
          <div>
            <h1 className="text-xl font-bold text-blue-600">Space</h1>
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 border-t">
          ...
          <Button variant="ghost" size="sm" className="w-full justify-start text-red-500 hover:bg-red-50" onClick={handleLogout}>
